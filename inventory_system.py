...
SESSION_BOOST_CATALOG = (
    {
        "id": "extra_slot",
        "title": "Карман +1",
        "desc": "На следующем выезде можно нести на 1 предмет больше.",
    },
    {
        "id": "budget_boost",
        "title": "Бюджет +25$",
        "desc": "Сразу +25$ сессии. Магазин этого выезда чуть богаче.",
    },
    {
        "id": "starter_candle",
        "title": "Стартовая свеча",
        "desc": "Следующий выезд начинается с одной свечой в инвентаре.",
    },
)
